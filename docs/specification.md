...
- `GET /stats`: cache statistics JSON; includes all gRPC `CacheStats` fields plus HTTP-only `memory_usage_mb`, `max_memory_mb`, `max_value_bytes`, `uptime_seconds`, `active_requests`, and `timestamp`
